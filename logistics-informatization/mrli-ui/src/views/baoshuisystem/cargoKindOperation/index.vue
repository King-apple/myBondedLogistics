      ...
      >
        ...
        <el-form-item>
          ...
          <el-button
            type="success"
            @click="printToExcel"
            v-if="permissions.cargoKindOperation_print"
            >打印</el-button
          >
        </el-form-item>
      </el-form>
      ...
      <div class="avue-crud">
        <el-table :data="dataList" border v-loading="dataListLoading">
          ...
          <el-table-column
            ...
            align="center"
            label="装卸船"
            :formatter="loadingShipFormatter"
          >
          </el-table-column>
          ...
          <el-table-column header-align="center" align="center" label="操作">
            <template slot-scope="scope">
              <el-button
                ...
                size="small"
                icon="el-icon-edit"
                v-if="permissions.cargoKindOperation_edit"
      ...
      >
        <el-form :inline="true" :model="operateForm">
          <el-form-item label="内外贸" prop="tradeId">
            ...
            >
              <el-option
                v-for="(item, index) in this.tradeIdOptions"
                :key="index"
                :label="item.label"
                :value="item.value"
              >
          ...
          <el-form-item label="装卸船" prop="loadingShip">
            <el-select
              v-model="operateForm.loadingShip"
              placeholder="请选择"
              filterable
              clearable
              style="width: 100%"
            >
              <el-option
                v-for="(item, index1) in this.loadingShipOptions"
                :key="index1"
                :label="item.label"
                :value="item.value"
              >
...
import {
  findBusinessList,
  getCargoKindOperation,
  cargoKindOperationPrintToExcel,
  putObj
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      getCargoKindOperation(Object.assign({
    ...
    printToExcel() {
      cargoKindOperationPrintToExcel(this.dataForm);
