	...
	<div class="mod-config">
		<basic-container>
          ...
          ></el-input>
				...
				<br />
				<el-form-item>
					<el-button v-if="permissions.inoutyardheadWare_add" icon="el-icon-plus" type="primary" @click="addOrUpdateHandle()">新增</el-button>
				</el-form-item>
				<el-form-item>
					<el-button v-if="permissions.inoutyardheadWare_export" icon="el-icon-plus" type="warning" :disabled="single" @click="downloadFile('保税仓库货物入库单', '模板')">导出</el-button>
				</el-form-item>
				<el-form-item>
					<el-button v-if="permissions.inoutyardhead_export" icon="el-icon-info" type="primary" :disabled="single" @click="expoprt('保税仓库货物入库单', '模板')">查看</el-button>
				</el-form-item>
				<el-form-item>
					<el-upload v-if="permissions.inoutyardheadWare_import" :headers="headers" :show-file-list="false" :on-success="uploadSuccess" class="avatar-uploader" action="/baoshuisystem/excelUploadDownload/uploadForInoutyardBodyAndHead" :on-progress="onProgress" :on-change="onChange" v-loading="fileLoading">
						<el-button icon="el-icon-upload2" size="small" type="success">导入</el-button>
					</el-upload>
				</el-form-item>
				<el-form-item>
					<el-button v-if="permissions.inoutyardheadWare_import" icon="el-icon-download" type="warning" @click="downloadFile2('保税仓库货物入库单', '')">下载导入模板</el-button>
				</el-form-item>

				<el-form-item>
					<el-button v-if="permissions.inoutyardheadWare_Busi" type="danger" size="small" :disabled="single" icon="el-icon-tickets" @click="addOrUpdateBusinessHandle('保税仓库货物入库单', '模板')">业务审核</el-button>
				</el-form-item>
				<!--<el-form-item>
              <el-button
                v-if="permissions.inoutyardheadWare_Oper"
                type="danger"
                size="small"
                :disabled="single"
          ...
          >
            <template slot-scope="scope">
              <span>{{ (pageIndex - 1) * pageSize + scope.$index + 1 }}</span>
					...
					<el-table-column prop="recordTim" header-align="center" align="center" label="操作时间" width="128" sortable>
					</el-table-column>
					<el-table-column prop="warehouseNam" header-align="center" align="center" label="仓库名称" width="150">
					</el-table-column>
					<el-table-column prop="inoutYardNo" header-align="center" align="center" label="单据编号" width="100" sortable>
					</el-table-column>
					<el-table-column prop="contNo" header-align="center" align="center" label="合同编号" width="160" sortable>
					</el-table-column>
					<el-table-column prop="inCustomsDeclaration" header-align="center" align="center" label="进区报关单号" width="160">
					</el-table-column>
					<el-table-column prop="inCheckNum" header-align="center" align="center" label="进区核注清单号" width="165">
					</el-table-column>
					<el-table-column prop="electronicAccountNum" header-align="center" align="center" label="电子账册号" width="110">
					</el-table-column>
					<el-table-column prop="customsBroker" header-align="center" align="center" label="报关代理企业" width="125" sortable>
					</el-table-column>
					<el-table-column prop="consignNam" header-align="center" align="center" label="作业委托人" width="110" sortable>
					</el-table-column>

					<el-table-column prop="operNam" header-align="center" align="center" label="添加人" width="95" sortable>
					</el-table-column>
              ...
              >-->
							<!--<el-button
                v-if="permissions.inoutyardheadWare_Busi"
                type="text"
                size="small"
                icon="el-icon-tickets"
		...
		<el-dialog title="进区核注清单号维护" :visible.sync="dialogVisible" width="30%">
			<el-form :model="form">
		...
		<el-dialog title="保税仓库入库单预览" :visible.sync="PrintdialogVisible" width="88%"  >
		...
		<el-dialog title="业务审核" :visible.sync="BUsinessVisible" width="88%">
	...
	export default {
		...
		methods: {
			...
			getDataList() {
				...
				this.dataForm.inOut = "1" //入库单查询
				this.dataForm.inoutYardKnd = "保税仓库货物入库" //单据类型
			...
			addOrUpdateBusinessHandle(filename, type) {
				...
				exportPrint(params).then((response) => { // 处理返回的文件流
					...
					if(response.status === 200) {
						...
						var newStr = innerHTML.slice(0, innerHTML.indexOf("v=\"作业委托人或代理企业签章 负责人签字\"") - 1) + ' style="text-align: left;height:120px;" valign="top" ' + innerHTML.slice(-(innerHTML.length - innerHTML.indexOf("v=\"作业委托人或代理企业签章 负责人签字\"")))
...
//				subOutputRankPrint.classList.add("table-html-wrap /deep/ table td")
