<template>
	<el-dialog :title="!dataForm.id ? '新增' : '修改'" width="70%" :close-on-click-modal="false" :visible.sync="visible">
		<el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
			<el-row class="table-row">
				<el-col :span="12">
					<el-form-item label="合同编号" label-width="140px" prop="contNo">
						<el-select clearable v-model="dataForm.contNo" style="width: 100%" placeholder="合同编号:" filterable>
							<el-option v-for="(item, index) in contractOptions" @click.native="selectContNo(item)" :key="index" :label="item.contNo" :value="item.contNo">
							</el-option>
						</el-select>
					</el-form-item>
				</el-col>
				<el-col :span="12">
					<el-form-item label="业务类型" label-width="140px" prop="businessType">
			...
			<el-row class="table-row">
				<el-col :span="12">
					<el-form-item label="单据名称" label-width="140px" prop="inoutYardNam">
						<el-select clearable v-model="dataForm.inoutYardNam" style="width: 100%" placeholder="单据名称:" filterable>
							<el-option v-for="(item, index) in inoutYardNamOptions" @click.native="selectInoutYardNam(item)" :key="index" :label="item.inoutYardNam" :value="item.inoutYardNam">
							</el-option>
						</el-select>
					</el-form-item>
				</el-col>
				...
				<el-col :span="12">
					<el-form-item label="仓库名称" label-width="140px" prop="warehouseNam">
			...
			<el-row class="table-row">
				<el-col :span="12">
					<el-form-item label="单据编号" label-width="140px" prop="inoutYardNo">
						<el-input v-model="dataForm.inoutYardNo" readonly="readonly" placeholder="单据编号"></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="12">
					<el-form-item label="电子账册号" label-width="140px" prop="electronicAccountNum">
						<el-input v-model="dataForm.electronicAccountNum" readonly="readonly" placeholder="电子账册号"></el-input>
					</el-form-item>
					<!--<el-form-item
            label="出区核注清单号"
            label-width="140px"
        ...
        <el-col :span="12">
          ...
          >
			...
			<el-row class="table-row">
				<el-col :span="12">
					<el-form-item label="报关代理企业" label-width="140px" prop="customsBroker">
						...
						<el-select clearable v-model="dataForm.customsBroker" style="width: 100%" placeholder="报关代理企业:" filterable>
							<el-option v-for="(item, index) in customsBrokerOptions" @click.native="selectFnSecond(item)" :key="index" :label="item.customsBrokerName" :value="item.customsBrokerName">
							</el-option>
						</el-select>
					</el-form-item>
				</el-col>
				<el-col :span="12">
					<el-form-item label="出区类别" label-width="140px" prop="outCategory">
						<el-select clearable v-model="dataForm.outCategory" style="width: 100%" placeholder="出区类别:" filterable>
							<el-option v-for="(item, index) in inCategoryOptions" :key="index" :label="item.label" :value="item.value">
							</el-option>
						</el-select>
			...
			<el-row class="table-row">
				<el-col :span="12">
					<el-form-item label="净重单位" label-width="140px" prop="netWetUnit">
						<el-select clearable v-model="dataForm.netWetUnit" style="width: 100%" placeholder="净重单位 " filterable>
							<el-option v-for="(item, index) in netWetUnitOptions" :key="index" :label="item.label" :value="item.label">
							</el-option>
						</el-select>
					</el-form-item>
				</el-col>
				<el-col :span="12">
					<el-form-item label="作业委托人" label-width="140px" prop="consignNam">
						<el-select clearable v-model="dataForm.consignNam" style="width: 100%" placeholder="作业委托人:" filterable>
							<el-option v-for="(item, index) in consignNamOptions" @click.native="selectFnThrid(item)" :key="index" :label="item.company" :value="item.company">
							</el-option>
						</el-select>
			...
			<el-row class="table-row">
				<el-col :span="12">
					<el-form-item label="单价类型" label-width="140px" prop="unitPriceKnd">
						<el-select clearable v-model="dataForm.unitPriceKnd" style="width: 100%" placeholder="单价类型 " filterable>
							<el-option v-for="(item, index) in unitPriceKndOptions" :key="index" :label="item.label" :value="item.label">
							</el-option>
						</el-select>
					</el-form-item>
				</el-col>
				<el-col :span="12">
					<el-form-item label="总价单位" label-width="140px" prop="unit">
						<el-select clearable v-model="dataForm.unit" style="width: 100%" placeholder="总价单位 " filterable>
			...
			<el-form-item label="附件" prop="urlFile" v-loading="fileLoading" element-loading-text="文件上传中" element-loading-spinner="el-icon-loading">
				<el-upload :headers="headers" :show-file-list="false" :on-success="uploadSuccess" class="avatar-uploader" action="/baoshuisystem/sys-file/upload" :on-progress="onProgress">
	...
	export default {
		...
		methods: {
			...
			dataFormSubmit() {
				...
				this.dataForm.inOutFlg = '1' //走审核判断进去核注清单号
