  ...
  >
    ...
    >
        ...
        <el-col :span="12">
          <el-form-item label="合同编号" prop="contNo" label-width="140px">
            ...
            >
             ...
             <el-input v-model="dataForm.contNo" disabled placeholder="合同编号"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
       ...
       <el-row class="table-row">
        <el-col :span="12">
          <el-form-item label="报关单号" prop="inCustomsDeclaration" label-width="140px">
            <el-input v-model="dataForm.inCustomsDeclaration" placeholder="报关单号"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-row class="table-row">
        ...
        <el-col :span="12">
          <el-form-item label="货类名称" prop="cargoKindNam" label-width="140px">
          	<el-select
              clearable
        ...
        <el-col :span="12">
          <el-form-item label="净重" prop="netWet" label-width="140px">
            <el-input
              ...
              @input="netWetValue"
              placeholder="净重"
            ></el-input><!--onkeyup="this.value=this.value.match(/\d+\.?\d{0,4}/)[0]"-->
          </el-form-item>
        </el-col>
      </el-row>
      <el-row class="table-row">
  ...
  methods: {
    ...
    getSelectContractList() {
    	getObjContract(this.dataForm.cFid).then((res) => {
		      ...
		      this.dataForm.cargoKindNo = res.data.data.inoutId
		      this.dataForm.cargoKindNam = res.data.data.tradeId
    	})
//    getSelectContract().then((res) => {
//      console.log(res)
//      this.settledContractOptions = res.data.data
//    })
    ...
    cargoList() {
      cargoList(Object.assign({})).then((res) => {
        console.log(res)
    ...
    netWetValue(val) {
    	if(isNaN(val)){
	      ...
	      console.log(this.dataForm.netWet)
