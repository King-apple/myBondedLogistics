    ...
    >
      <el-form-item label="">
        ...
        <div style="float: right; margin-top: 20px">
          <el-button
            type="primary"
            @click="agreeOrDisAgree(dataForm.fId, '1', dataForm.optionExplain,contractForm)"
            >同意</el-button
          >
          <el-button
            type="danger"
            @click="agreeOrDisAgree(dataForm.fId, '2', dataForm.optionExplain,contractForm)"
            >驳回</el-button
          >
        </div>
      </el-form-item>
...
export default {
  ...
  methods: {
    init(id, row) {
      ...
      var map = { billFid: this.contractForm.fId, processNo: '0' }
    ...
    agreeOrDisAgree(fId, isAgree, optionExplain,dataForm) {
      ...
      if (this.canSubmit) {
        ...
        var map = { fId: fId, isAgree: isAgree, opinion: opinion, opinionExplain: optionExplain, processNo: '0',completeApprovalFlag:dataForm.completeApprovalFlag }
        this.loading = true
