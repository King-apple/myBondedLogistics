  ...
  <div class="mod-config">
    <basic-container>
      ...
      >
        ...
        <el-form-item>
          <el-button
            v-if="permissions.inoutyardhead_add"
            icon="el-icon-plus"
            type="primary"
        ...
        <el-form-item>
          <el-button
            ...
            type="warning"
            :disabled="single"
            @click="downloadFile('保税物流中心入库单', '模板')"
            >导出</el-button
          >
        </el-form-item>
        <el-form-item>
        ...
        <el-form-item>
          <el-upload
            v-if="permissions.inoutyardhead_import"
            :headers="headers"
        ...
        <el-form-item>
          <el-button
            v-if="permissions.inoutyardhead_Busi"
            type="danger"
            size="small"
            :disabled="single"
            icon="el-icon-tickets"
            @click="addOrUpdateBusinessHandle('保税物流中心入库单', '模板')"
            >业务审核</el-button
          >
        </el-form-item>
        <!--<el-form-item>
              <el-button
                v-if="permissions.inoutyardhead_Oper"
                type="danger"
                size="small"
                :disabled="single"
                icon="el-icon-tickets"
          ...
          >
            <template slot-scope="scope">
              ...
              <el-button
                ...
                >表体</el-button
              >
              <!--v-show="scope.row.businessCheckStatus=='0' || scope.row.businessCheckStatus=='2'"-->
              <!--<el-button
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.dataForm.inoutYardKnd = "保税物流中心入库" //单据类型
      ...
      getBusinessOptions().then(res => {
          ...
          console.log("this.businessKndOptions",this.businessKndOptions)
      })
