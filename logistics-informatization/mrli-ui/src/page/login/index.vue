<template>
  <div class="login-container">
    <div class="login-weaper animated bounceInDown">
      <div class="login-logo" weight="100%">
        <img src="/img/logoship.png" alt />
      </div>
      <p class="login-tip">{{ website.title}} v 2.0</p>
    ...
    <div class="login-end" >
      <el-row style="margin:0 240px;">
        <el-col span="6">
          <el-row>
            <font size="4" ><strong>散货港口信息化解决方案</strong></font>
          </el-row>
          <el-row>
            <font>电子围栏</font>
          </el-row>
        ...
        <el-col span="6">
          <el-row>
            <font size="4"><strong>平台介绍</strong></font>
          </el-row>
          <el-row>
            <font>船舶服务</font>
          </el-row>
        ...
        <el-col span="6">
          <el-row>
            <font size="4"><strong>合作伙伴</strong></font>
          </el-row>
          <el-row>
            <font>港港网</font>
          </el-row>
        ...
        <el-col span="6">
          <el-row>
            <font size="4"><strong>关于我们</strong></font>
          </el-row>
          <el-row>
            <font>联系方式</font>
          </el-row>
    ...
    <div class="login-copyright">
      Copyright © 2020 营口港务集团. All rights reserved.
